...
//记得更新时要更新zexo_ver, package-lock.json, package.json, update.js(两处)
//开发者请将上述依赖注释去除

const hpp_CDNver = "d4051c3"
const zexo_ver = "Zexo@0.2.2"
    ...
    <a href="javascript:zexo_trigger_deploy()" id="triggerDeployBtn">
        <div class="card card-stats">
            ...
            <div class="card-footer">
              ...
              hpp_js = `<script src='https://cdn.jsdelivr.net/gh/HexoPlusPlus/HexoPlusPlus@${hpp_CDNver}/tool.js'></script><script src="cdn.bootcdn.net/ajax/libs/eruda/2.3.3/eruda.js"></script>
